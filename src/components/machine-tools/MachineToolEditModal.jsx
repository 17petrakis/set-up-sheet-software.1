...
export default function MachineToolEditModal({ tool, onChange, onClose }) {
  ...
  // Reorder: name first, then the rest of TOOL_FIELDS
  const orderedFields = [
    ...
    <Dialog open={true} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-[80px_1fr] gap-3">
            <div>
              ...
              <Input
                ...
                readOnly
                className="h-8 text-xs text-center font-mono bg-muted/50 cursor-not-allowed"
              />
            </div>
            <div>
          ...
          {/* All toggleable fields — name first */}

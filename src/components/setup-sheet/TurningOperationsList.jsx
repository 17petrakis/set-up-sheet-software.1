...
const columns = [
  ...
  { key: "min_z", label: "Min Z", w: "w-20" },
  { key: "max_z", label: "Max Z", w: "w-20" },
];

const emptyTurningOperation = {
  n_block: "", op_number: "", operation_name: "", comment: "", tool_number: "", cs_number: "", min_z: "", max_z: "",
};

export default function TurningOperationsList({ operations = [], onChange }) {
  const addRow = () => onChange([...operations, { ...emptyTurningOperation }]);

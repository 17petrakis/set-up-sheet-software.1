  ...
  return (
    <div className="space-y-3">
      <FixturingField label="Fixture Type">
        <ChipGroup value={data.fixture_type || ""} onChange={(v) => update("fixture_type", v)} options={DT_FIXTURE_TYPES} />
      </FixturingField>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <FixturingField label="Work Offset">
          <ChipGroup value={data.work_offset || ""} onChange={(v) => update("work_offset", v)} options={DT_WORK_OFFSETS} />
        </FixturingField>

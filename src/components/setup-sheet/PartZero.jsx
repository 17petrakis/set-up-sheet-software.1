...
export default function PartZero({ data, onChange }) {
  ...
  // coord_systems is just an array of strings (or objects with coordinate_system)
  ...
  return (
    <Card className="border-border/50 shadow-sm">
      <CardContent className="pt-5 pb-5">
        ...
        <div className="grid grid-cols-1 gap-3 mb-4 max-w-xs">
          <div className="rounded-lg border border-border/60 bg-muted/30 p-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <Label className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1 block">MAX</Label>
                <Input
                  value={data.z_max ?? ""}
              ...
              <div>
                <Label className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1 block">MIN</Label>
                <Input
                  value={data.z_min ?? ""}
        ...
        {/* Max Depth & C Axis Offset — fixed fields */}
